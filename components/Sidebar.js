          ...
          <nav className="mt-10 px-6">
            <div>
              ...
              >
                ...
                <span className="mx-4 text-md font-normal">Asesor</span>
              </a>
              <a
                className="hover:text-gray-800 font-thin text-gray-500 dark:text-gray-400 hover:bg-gray-100 flex items-center p-2 my-4 dark:hover:text-white dark:hover:bg-gray-600 duration-200 justify-start"
                href="#"
                onClick={() => {
                  setMenu(2);
                }}
